...
class Book // extends Object <-- HashSet is comparing based on hashCode() of Object class
           // equals() method
{
    int bookNumber;
    String bookName;
    ...
    public String toString() {
        return this.hashCode() + " Book [bookNumber=" + bookNumber + ", bookName=" + bookName + ", bookPrice="
                + bookPrice + "]";
    }
