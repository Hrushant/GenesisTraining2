public class App2 {
    public static void main(String[] args) {
        ...
        Thread thread5 = new Thread(truck);
...
class HorseCart implements Runnable {
    public void run() {
        // System.out.println("put the horses infront of the cart, and not behind the
        // cart.. dear mind of the human...");
...
class Truck implements Runnable{
    public void run(){
        System.out.println("Truct is running...");
    }
}